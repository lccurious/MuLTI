...
https://github.com/brendel-group/cl-ica/blob/69568d9448de1d9acd58df98a4014a0c524d5978/disentanglement_utils.py
"""
...
def permutation_disentanglement(
    ...
    mode="r2",
    rescaling=True,
    solver: Union[Literal["naive"], Literal["munkres"]] = "naive",
    sign_flips=True,
